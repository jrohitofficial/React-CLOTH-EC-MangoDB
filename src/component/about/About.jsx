              ...
              <div className="about__page">
                ...
                <div className="row flex">
                  <div className="col__2">
                    <img src="https://res.cloudinary.com/kingsly/image/upload/v1677429600/bbb_ym5jqg.jpg" />
                  </div>
                  <div className="col__2">
                    <div className="meta">
                      <span
                      ...
                      >
                        Welcome to Trendy Wear                      </span>
                      <p>
               

Welcome to Trendy Wear, where fashion and individuality converge to create a unique shopping experience. Established recently in 2023 , we have been dedicated to providing our customers with exceptional clothing and unparalleled service.

                      <p>
                    

At Trendy Wear, we believe that clothing is more than just fabric; it's a reflection of who you are and how you want to express yourself to the world. Our vision is to empower individuals to embrace their personal style, confident in the knowledge that the perfect outfit can inspire confidence and make a statement. </p>
   </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row flex">
                    <div className="col__3">
                      ...
                      >
                        ...
                        <p>
                          There are many variations of passages of sport wares
